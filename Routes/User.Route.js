...
User_Router.get('/index',Authentication.IsLoggedIn,User_Controller.ShowHome );
...
User_Router.post('/forgot',User_Controller.UserForgotPassword);

User_Router.get('/forgot-password',Authentication.IsLoggedOut, User_Controller.ShowForgotPassword);

User_Router.post('/forgot-password',User_Controller.ResetPassword);
...
User_Router.post('/edit',Upload.single('image'),User_Controller.EditUserData);
